...
function UserCategory({ category, changeCategories }) {
    ...
    return (
        <tr>
            ...
            <td className="flex flex-wrap p-4 px-6 text-xs align-middle border-t-0 border-l-0 border-r-0 md:flex-row md:overflow-y-auto whitespace-nowrap">{category.description}</td>
