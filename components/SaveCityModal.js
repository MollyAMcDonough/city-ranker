...
export default function SaveCityModal({ cityName, categories }) {
  ...
  function handleSubmit(e) {
    ...
    //   tomorrow work on submitting with axios to create new user_city with cityData
  }
